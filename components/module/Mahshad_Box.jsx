    ...
    <div className='flex justify-center mt-5 px-52 '>
      <div className='w-7/12 h-52 bg-primary grid grid-cols-12 rounded-2xl '>
        ...
        <div className='h-52  col-span-4 flex flex-col justify-center items-center'>
           <p className='text-green-800  text-md mt-2 font-Estedad-Regular'>ذکر صلوات</p>
           <p className='text-green-800  text-md mt-2 font-Estedad-Regular'>{count}</p>
           <button onClick={handleClick} className='w-14 h-12 border-2 border-lime-500 text-3xl mt-2 rounded-md hover:bg-accent'>+</button>
        </div>
        
        <div className='h-52  col-span-4 flex flex-col justify-center items-center'>
           <p className='text-green-800 text-md mt-2 font-Estedad-Regular'>قرائت فاتحه</p>
           <p className='text-green-800 text-md mt-2 font-Estedad-Regular'>{num}</p>
           <button onClick={handleClick2} className='w-14 h-12 border-2 border-lime-500 text-3xl mt-2 rounded-md hover:bg-accent'>+</button>
        </div>

        <div className='h-52  col-span-4 flex flex-col justify-center items-center'>
           <p className='text-green-800 text-md mt-2 font-Estedad-Regular'>خواندن قرآن</p>
           <p className='text-green-800 text-md mt-2 font-Estedad-Regular'>{number}</p>
